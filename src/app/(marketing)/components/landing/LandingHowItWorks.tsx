...
export function LandingHowItWorks() {
  return (
    <section id="how-it-works" className="py-14 md:py-18 lg:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-4xl space-y-6 md:space-y-8">
          {[
              ...
              <div key={item.step} className="glass-card animate-rise-in flex items-start gap-4 rounded-2xl p-4 sm:p-5">
              ...
              <div>
                  ...
                  <p className="text-sm text-slate-300 sm:text-base">{item.description}</p>
              </div>
            </div>
          ))}
          ...
          <div className="pt-4 text-center">
            <TrackedLink
              ...
              eventParams={{ location: 'how_it_works' }}
              className="inline-flex items-center rounded-xl border border-white/20 px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-orange-300 hover:text-orange-200"
            >
